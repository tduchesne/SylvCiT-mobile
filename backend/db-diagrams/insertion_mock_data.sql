...
-- START TRANSACTION;
-- USE `inm5151_db`;
-- INSERT INTO `inm5151_db`.`parc`(code_parc, nom_parc)
-- VALUES ('1265-000', 'PROMENADE DES ARTISTES');
-- INSERT INTO `inm5151_db`.`secteur`(code_secteur, nom_secteur)
-- VALUES ('2', 'OUEST');
-- INSERT INTO `inm5151_db`.`arrondissement`(no_arrondissement, nom_arrondissement)
-- VALUES (6, 'Ville-Marie');
-- INSERT INTO `inm5151_db`.`essence`(sigle, la, en, fr)
-- VALUES (
--         'ULWIPR',
...
--         true
--     );
-- INSERT INTO `inm5151_db`.`tree_hors_rue`(id, code_parc, code_secteur)
-- VALUES (1, '1265-000', '2');
-- COMMIT;
-- START TRANSACTION;
-- USE `inm5151_db`;
...
--         true
--     );
-- INSERT INTO `inm5151_db`.`tree_rue`(
--         id,
--         adresse,
--         localisation,
--         localisation_code,
...
-- VALUES (
--         2,
--         '1 Rue Jeanne-Mance E',
--         '25 m. au Nord de PRÉSIDENT-KENNEDY',
--         'N-25',
--         'PRÉSIDENT-KENNEDY AVENU DU',
--         'SHERBROOKE O RUE',
--         2.6,
--         3.7,
--         'L-V',
