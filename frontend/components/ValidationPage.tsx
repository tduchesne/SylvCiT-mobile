...
export default function ValidationScreen({
  ...
  propsTreeList: Tree[];
  startIdx: number;
  handleEndValidation: () => void;
}) {
  const [treeData, setTreeData] = useState<Tree | null>(
    propsTreeList[startIdx]
  );
  ...
  return (
    ...
    >
            ...
            <View style={styles.infoContainer}>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>
                  {formatDate(treeData?.date_plantation)}
                </Text>
              </View>
              <View style={styles.infoRow}>
                <Text
                ...
                <Text style={styles.infoValue}>
                  {formatDate(treeData?.date_measure)}
                </Text>
              </View>
              <View style={styles.infoRow}>
                <Text
      ...
      >
        <ImageViewer
          imageUrls={[{ url: treeData?.image_url || "" }]}
          enableSwipeDown
      ...
      >
        <TouchableOpacity
          style={[
            ...
            { borderColor: isDarkMode ? "#8b0000" : "#c62828" },
          ]}
        ...
        >
          <Text
            style={[
              styles.buttonText,
              { color: isDarkMode ? "#8b0000" : "#c62828" },
            ]}
          >
            Modifier
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.skipButton,
            styles.buttonOutline,
            { borderColor: isDarkMode ? "#ffd700" : "#fdd835" },
          ]}
          onPress={handleSkip}
        >
          <Text
            style={[
              styles.buttonText,
              { color: isDarkMode ? "#ffd700" : "#fdd835" },
            ]}
          >
            Sauter
          </Text>
        ...
        <TouchableOpacity
          style={[
            ...
            styles.buttonOutline,
            { borderColor: isDarkMode ? "#006400" : "#2e7d32" },
          ]}
        ...
        >
          <Text
            style={[
              styles.buttonText,
              { color: isDarkMode ? "#006400" : "#2e7d32" },
            ]}
          >
            Valider
          </Text>
