        ...
        <View>
          ...
          <View style={[styles.input]}>
            ...
            >
              ...
              {functionalGroup.map((functionalGroup) => (
                <Picker.Item
                  key={functionalGroup["id_functional_group"]}
                  label={functionalGroup["group"]}
                  value={functionalGroup["group"]}
                />
              ))}
            </Picker>
          </View>
          ...
          <View style={styles.labelCal}>
            ...
            <Ionicons.Button
              ...
              name="calendar"
              onPress={() => setModalDatePreleve(true)}
            />
            {modalDatePreleve && (
              <DateTimePicker
                value={dateReleve}
          ...
          >
            {formatDate(dateReleve)}
          </TextInput>
          <View style={styles.labelCal}>
            <ThemedText style={styles.label}>Date de plantation</ThemedText>
            <Ionicons.Button
              backgroundColor={Colors[colorScheme ?? "light"].buttonBackground}
              name="calendar"
